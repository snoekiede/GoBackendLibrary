...
VALUES ($1, $2, $3, $4)
RETURNING id, title, author, description, year_of_publication, created_at, updated_at
`
...
SELECT id, title, author, description, year_of_publication, created_at, updated_at FROM books
WHERE id = $1
`
