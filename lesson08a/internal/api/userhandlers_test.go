...
func (m *MockUserQueries) DeleteUser(ctx context.Context, id int32) (int32, error) {
...
func TestCreateUser(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			mockError:      &pgconn.PgError{Code: "23505"}, // Unique violation error code
